...
async function load(){
  ...
  try{
    ...
    meta.innerHTML = `Источник: ${d.source} · <a class="btn secondary" href="/details?${detailsQ}">Сырые строки</a> <a class="btn secondary" href="/">На дашборд</a>`;
  }catch(e){
    meta.textContent = 'Ошибка: ' + (e.message||e);
  }
}
